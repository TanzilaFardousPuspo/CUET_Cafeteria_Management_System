...
<head>
    ...
    <style>
        ...
        .column {
            ...
            text-align: left;
            width: 36.4em;
            flex-basis: 80%; /* Adjust the width of the columns as needed */
...
<body style="background-image: url(121.jpg); background-repeat: no-repeat;background-size: cover;">
    <?php
        ...
        if ($reservationStatus === 'success') {
            ...
            echo '<a class="nav-link" href="../order/posBackend/posTable.php">' .
            '<h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">Welcome to CUET TSC</h1>' .
            '<button style="background-color: red">Click here<button>'.
    ...
    <div class="reserve-container">
        <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;font-size: 50px;padding-right: 170px">CUET TSC</h1>
        ...
        <div class="row">
            <div class="column">
                <div id="Search Table">
                    <h2 style=" color:white;font-size: 35px">Search for Time</h2>
                 
                    <form id="reservation-form" method="GET" action="availability.php"><br>
                        <div class="form-group">
                        <label for="reservation_date" style="font-size: 20px">Select Date</label><br>
                        <input class="form-control" type="date" id="reservation_date" name="reservation_date" required>
                        </div>
                        <div class="form-group">
                        <label for="reservation_time" style="font-size: 20px">Available Reservation Times</label>
                        ...
                        <button type="submit" style="background-color: red; color: rgb(234, 234, 234); " class="btn" name="submit" >Search</button>
                    </form>
                </div>
            </div>
            ...
            <div class="column right-column">
                <div id="insert-reservation-into-table">
                    <h2 style=" color:white;font-size: 35px">Make Reservation</h2>
                    <form id="reservation-form" method="POST" action="insertReservation.php">
                        <br>
                        <div class="form-group">
                            <label for="customer_name" style="font-size: 20px">Customer Name</label><br>
                        ...
                        <div class="form-group " >
                            <label for="reservation_date" style="font-size: 20px">Reservation Date</label><br>
                        ...
                        <div class="form-group">
                            <label for="table_id_reserve" style="font-size: 20px">Available Tables</label>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <button type="submit" style="background-color: red; color: rgb(234, 234, 234); " class="btn" type="submit" name="submit">Make Reservation</button>
                        </div>
                    </form>
                </div>
            </div>
