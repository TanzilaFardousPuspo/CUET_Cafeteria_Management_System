...
<body style="background-color: #9BACB3">
 <!-- Header -->
    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;">  CUET TSC</h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
        ...
        <ul>
          ...
          <li><a href="../order/StaffLogin/login.php" data-after="Service">Order</a></li> -->
...
<section id="hero" style="position: relative;">
    <img src="../image/ts.png" alt="Your Alt Text" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;font-size: 40px;font-style: italic;margin-left: 550px"> Are You Hungry?</h1><span></span></strong></h1>
            <h1><strong style="color:white;font-size: 80px;font-style: italic;margin-left: 550px">DON'T WAIT!<span></span></strong></h1>
  ...
  <section id="projects">
    <div class="projects container">
      <div class="projects-header">
        <h1 class="section-title" style="font-size: 80px;font-weight: bold">Menu</h1>
      </div>
    ...
    <div class="yellow msg"> 
        ...
        <div></div>
      <div class="mainDish">
           <h1 style="text-align:center;padding-bottom: 30px;font-size: 28px;font-weight: bold">MAIN DISHES</h1>
          <?php foreach ($mainDishes as $item): ?>
      <p>
        <span class="item-name" style="font-size: 18px;font-weight: bold"> <strong><?php echo $item['item_name']; ?></strong></span>
        <span class="item-price" style="font-weight: bold;">BDT <?php echo $item['item_price']; ?></span><br>
    ...
    <div class="red msg">
        <div></div>
      <div class="sideDish">
           <h1 style="text-align:center;padding-bottom: 30px;font-size: 28px;font-weight: bold"">SIDE DISHES</h1>
    ...
    <div class="green msg">
        <div></div>
      <div class="drinks">
           <h1 style="text-align:center;padding-bottom: 30px;font-size: 28px;font-weight: bold"">DRINKS</h1>
...
<section id="about" ">
  <div class="about container">
    <div class="col-right">
        <h1 class="section-title" style="font-weight: bold;font-size: 70px">About Us</h1>
        <h2 style="font-weight: bold">CUET Online Cafeteria Management System</h2>
 <p style="font-size: 20px">Our CUET cafeteria is more than just a place to eat; it's a hub of diverse and delicious dishes catering not only to students but also to our esteemed teachers and university employees. From hearty breakfasts to satisfying lunches and tempting snacks, we offer a range of options to suit every palate.
 </p>
 <p style="font-size: 20px">Students, faculty, and staff can create accounts to access the online cafeteria system.Digital display of the cafeteria menu with detailed information about items. Users can place food orders online, specifying quantities and preferences.Integration with online payment systems for cashless transactions.Users can provide feedback on the quality of food and service.Dedicated to ensuring satisfaction for everyone, our focus extends to providing a positive and enjoyable dining experience for students, teachers, and university employees. Join us at CUET TSC, where good food meets great company, and every meal is a celebration of academic and gastronomic delight.
 </p>
...
<section id="contact" ">
  <div class="contact container">
    <div>
      <h1 class="section-title" style="font-weight: bold;font-size: 65px">Contact Info</h1>
    </div>
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2>Pahartali, Raozan, Chittagong ,Bangladesh</h2>
        </div>
      </div>
    </div>
  </div>
...
<!-- End Contact Section -->
  ...
  <section id="footer">
    <div class="footer container">
        <div class="brand">
          <h1>CUET Cafeteria Management System</h1>
      </div>
      ...
      <div class="social-icon">
        ...
        <div class="social-item">
          <a href=""><img src="https://img.icons8.com/color/48/instagram-new.png" alt="instagram-new"/></a>
        </div>
          <div class="social-item">
          <a href=""><img src="https://img.icons8.com/color/48/pinterest.png" alt="pinterest-new"/></a>
        </div>
          <!-- <div class="social-item">
          <a href=""><img src="https://img.icons8.com/color/48/tiktok.png" alt="tiktok-new"/></a>
        </div> -->
          <div class="social-item">
...
.menu-category:hover {
  ...
  color: white; /* Black text on hover */
      ...
      .msg {
        ...
        grid-gap: 80px; /* Adjust the gap between items */
      }
