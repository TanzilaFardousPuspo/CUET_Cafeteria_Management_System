...
.register-container {
  ...
  max-width: 500px; /* Set a maximum width for the container */
        ...
        .register_wrapper {
            width: 750px; /* Increase the container width */
            padding: 20px;
        }
...
<body>
    ...
    <div class="register_wrapper"> <!-- Updated class name -->
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;font-size: 50px"> CUET TSC</h1><span class="sr-only"></span></a><br>
        ...
        <form action="register.php" method="post">
            ...
            <button style="background-color:red;font-size: 35px" class="btn btn-dark" type="submit" name="register" value="Register">Register</button>
           
        </form>

        <p style="margin-top:1em; color:white;font-size: 20px">Already have an account? <a href="../customerLogin/login.php" >Proceed to Login</a></p>
    </div>
    </div>
</body>
</html>
