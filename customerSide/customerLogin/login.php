                    ...
                    if ($password === $row["password"]) {
                        ...
                        if ($result_member) {
                            ...
                            if ($membership_row) {
                                ...
                                header("location: ../CustomerReservation/reservePage.php");
  ...
  max-width: 500px; /* Set a maximum width for the container */
        ...
        body {
            ...
            background-color:black;
             background-image: url('../image/5.jpg'); /* Set the background image path */
        ...
        .login_wrapper {
            width: 750px; /* Adjust the container width as needed */
            padding: 20px;
        }
        ...
        .form-group {
            margin-bottom: 35px; /* Add space between form elements */
        }
...
<body>
    ...
    <div class="login_wrapper">
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;font-size: 50px"> CUET TSC</h1><span class="sr-only"></span></a>
    ...
    <span class="text-danger"><?php echo $password_err; ?></span>
            ...
            <button class="btn btn-dark" style="background-color:red;font-size: 35px" type="submit" name="submit" value="Login">Login</button>
            
        </form>

            <p style="margin-top:1em; color:white;font-size: 20px">Don't have an account? <a href="register.php" style="">Proceed to Register</a></p>
        </div>
    </div>
    </div>
</body>
