            ...
            <div class="row">
                <div class="m-50">
                    <div class="mt-5 mb-3">
                        ...
                        <a href="../reservationsCrud/createReservation.php" class="btn btn-outline-dark" style="background-color: #008000;color: white"><i class="fa fa-plus"></i> Add Reservation</a>
                    </div>
                    <div class="mb-3">
