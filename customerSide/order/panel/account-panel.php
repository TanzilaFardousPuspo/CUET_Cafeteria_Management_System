            ...
            <div class="row">
                <div class="m-50">
                    <div class="mt-5 mb-3">
                        ...
                        <a href="../staffCrud/createStaff.php" class="btn btn-outline-dark" style="background-color: #008000;color: white"><i class="fa fa-plus"></i> Add Staff</a>
                        <a href="../customerCrud/createCust.php" class="btn btn-outline-dark" style="background-color: #008000;color: white"><i class="fa fa-plus"></i> Add Memberships</a>
                    </div>
