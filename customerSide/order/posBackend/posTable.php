...
<body style="background-image: url(12.jpg);background-repeat: no-repeat;background-size: 2055px 1055px;background-attachment: fixed;padding-left: 300px;background-position: 225px 55px;">
        ...
        <div class="row center-middle">
            ...
            <div class="col-md-15" style="margin-left: 17rem; margin-top: 0rem;max-height: 700px; overflow-y: auto;">
              ...
              <div class="row d-flex justify-content-around"style="margin-top: 2rem;" >
                ...
                -->
                <div class="col-md-3">
                    <div class="alert alert-warning" style="color:black;background-color: #FF8629;" role="alert" data-toggle="tooltip" data-placement="top" title="Tables That are Reserved">
                        Reserved
                    </div>
