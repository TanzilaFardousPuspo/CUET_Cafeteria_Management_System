                            ...
                            <div style="max-height: 40rem;overflow-y: auto;">
                                ...
                                if ($cart_result && mysqli_num_rows($cart_result) > 0) {
                                    while ($cart_row = mysqli_fetch_assoc($cart_result)) {
                                        ...
                                        if (!$has_payment_time) {
                                            echo '<td><a class="btn btn-dark" style="background-color: red" href="deleteItem.php?bill_id=' . $bill_id . '&table_id=' . $table_id . '&bill_item_id=' . $bill_item_id . '&item_id=' . $item_id .'">Delete</a></td>';
                                        } else {
                                            echo '<td>Bill Paid</td>';
                                        }
                                        echo '</tr>';
            ...
            <tr>
                ...
                <td>BDT <?php echo number_format(($tax * $cart_total) + $cart_total, 2); ?></td>
                        ...
                        if ($has_payment_time) {
                            ...
                            echo '<br><a style="background-color: #008000" href="idValidity.php?bill_id=' . $bill_id . '" class="btn btn-success">Pay Bill</a>';
                        } else {
                    ...
                    <?php 
                       echo '<form class="mt-3" action="newCustomer.php" method="get">'; // Add this form element
                        ...
                        echo '<button type="submit" name="new_customer" value="true" class="btn btn-warning" style="background-color: black;color: white">New Customer</button>';
                        echo '</form>';
