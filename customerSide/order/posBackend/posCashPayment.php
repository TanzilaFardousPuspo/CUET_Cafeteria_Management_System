...
<body>
            ...
            <div class="col-md-8">
                ...
                ?>
                        ...
                        <div class="text-right">
                            ...
                            // echo "<strong>Tax (0%):</strong> BDT " . number_format($cart_total * $tax, 2) . "<br>";
    ...
    <div id="cash-payment" class="container-fluid mt-5 pt-5 pl-5 pr-5 mb-5">
        <div class="row">
            <div class="col-md-6">
                <h1 style="color: white">Cash Payment</h1>
                <form action="" method="get">
                    ...
                    <button type="submit" id="cardSubmit" class="btn btn-dark mt-2" style="background-color: #008000;font-size:20px">Pay</button>
                </form>
            </div>
            <div class="col-md-6">
            <?php
