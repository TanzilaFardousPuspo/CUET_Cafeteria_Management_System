...
<div id="card-payment" class="col-md-6 order-md-2" style="margin-top: 12rem; margin-right: 20rem;max-width: 40rem;">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_payment_result) {
        ...
        if ($row['card_id'] !== null) {
            ...
            echo "Bill has already been paid </div>";
            
            echo '<br><a href="posTable.php" class="btn btn-dark" Style="background-color: #008000">Back to Tables</a>';
