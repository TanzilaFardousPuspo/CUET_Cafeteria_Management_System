...
<body style="background-image: url(chef.jpg); background-repeat: no-repeat;background-size: cover;">
    ...
    <a class="nav-link" href="../../customerSide/home/home.php"> <h1 class="text-center" style="font-family:Copperplate; color:white;font-size: 50px"> Staff Management</h1><span class="sr-only"></span></a>
    ...
    <form action="login_process.php" method="post" >
        <div class="form-group">
            <label for="account_id" style="font-size: 25px">Staff ID</label>
